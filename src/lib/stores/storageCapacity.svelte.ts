...
/**
 * Factory function to create storage capacity store
 * Encapsulates all state and logic within the factory
 */
function createStorageCapacity() {
  // Reactive state
  ...
  // Return store object with getters for reactivity
  // Note: Getters ARE required for Svelte 5 reactivity with module-level $state
  return {
 ...
 */
export const storageCapacity = createStorageCapacity();
